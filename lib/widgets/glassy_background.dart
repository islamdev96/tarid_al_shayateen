...
/// A premium ambient background widget featuring animated glowing mesh gradient blobs.
/// This provides the colorful backing required for high-end iOS frosted-glassmorphism.
///
/// This is a backward-compatible wrapper. New screens should use [GlassScaffold] directly.
class GlassyBackground extends StatefulWidget {
  final Widget child;

  const GlassyBackground({super.key, required this.child});

  @override
  State<GlassyBackground> createState() => _GlassyBackgroundState();
}

class _GlassyBackgroundState extends State<GlassyBackground>
